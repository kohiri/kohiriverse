    ...
    <>
      <div className="relative">
        ...
        <button
          ...
          className={`group flex flex-col items-center justify-center w-11 h-11 transition-all duration-500 active:scale-90 z-50 pointer-events-auto rounded-full border shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_8px_16px_-4px_rgba(0,0,0,0.5)] ${
            isOpen 
        ...
        {/* Dropdown Menu */}
        <div 
          className={`absolute top-14 right-0 w-56 bg-white/[0.01] backdrop-blur-3xl border border-white/10 rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)] transition-all duration-500 origin-top-right z-40 ${
        ...
        >
          <div className="p-3 space-y-1">
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3.5 text-[10px] tracking-[0.2em] text-white/40 hover:text-white hover:bg-white/10 rounded-2xl transition-all group"
            >
              <div className="w-4 flex justify-center opacity-70 group-hover:opacity-100">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>
              </div>
      ...
      >
        ...
        <div className={`relative max-w-lg w-full bg-white/[0.01] backdrop-blur-3xl border border-white/10 rounded-[2.5rem] overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.8),inset_0_1px_1px_rgba(255,255,255,0.05)] transition-all duration-700 ${
          showAbout ? 'scale-100 translate-y-0 opacity-100' : 'scale-95 translate-y-4 opacity-0'
        }`}>
          <div className="p-10 md:p-14 space-y-10">
            <div className="flex justify-between items-start">
              <div className="space-y-2">
                <h2 className="text-white text-3xl font-extralight tracking-[0.3em] uppercase opacity-90">About Me</h2>
                <div className="w-16 h-0.5 bg-white/10"></div>
              </div>
              <button 
                onClick={() => setShowAbout(false)}
                className="p-2 text-white/20 hover:text-white transition-all duration-300 hover:rotate-90"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
              </button>
            </div>

            <div className="space-y-8 text-white/50 text-sm font-light leading-relaxed tracking-wider max-h-[50vh] overflow-y-auto pr-6 custom-scrollbar">
              <p className="text-white/80 font-normal text-lg">Hi, I’m Kohiri.</p>
            ...
            <div className="pt-6 flex items-center gap-8">
              {socials.map((social) => (
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white/20 hover:text-white transition-all duration-500 transform hover:-translate-y-2"
                  title={social.name}
                >
                  {social.icon}
                </a>
