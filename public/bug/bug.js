...
var BugDispatch = {
    ...
    options: {
        ...
        maxSmallTurnDeg: 10,
        maxWiggleDeg: 5,
        imageSprite: '/bug/fly-sprite.png',
        bugWidth: 13,
        bugHeight: 14,
        num_frames: 5,
...
var SpiderController = function() {
    var spiderOptions = {
        imageSprite: '/bug/spider-sprite.png',
        bugWidth: 69,
        bugHeight: 90,
        num_frames: 7,
        canFly: false,
...
var Bug = {
    ...
    setPos: function(top, left) {
        var container = this.options.container || document.documentElement;
        this.bug.top = top || this.random(this.options.edge_resistance, container.clientHeight - this.options.edge_resistance);

        this.bug.left = left || this.random(this.options.edge_resistance, container.clientWidth - this.options.edge_resistance);
    ...
    drawBug: function(top, left) {
        ...
        if (!this.inserted) {
            this.inserted = true;
            (this.options.container || document.body).appendChild(this.bug);
        }
    },
    ...
    flyRand: function() {
        ...
        var landingPosition = {};
        var container = this.options.container || document.documentElement;
        landingPosition.top = this.random(this.options.edge_resistance, container.clientHeight - this.options.edge_resistance);
        landingPosition.left = this.random(this.options.edge_resistance, container.clientWidth - this.options.edge_resistance);
    ...
    flyIn: function() {
        ...
        var side = Math.round(Math.random() * 4 - 0.5),
            container = this.options.container || document.documentElement,
    ...
    drop: function(deathType) {
        var startPos = this.bug.top,
            container = this.options.container || document.documentElement,
            finalPos = container.clientHeight,
    ...
    bug_near_window_edge: function() {
        ...
        else if (this.bug.top > container.clientHeight - this.options.edge_resistance)
            this.near_edge |= this.NEAR_BOTTOM_EDGE;
        if (this.bug.left < this.options.edge_resistance)
            this.near_edge |= this.NEAR_LEFT_EDGE;
        else if (this.bug.left > container.clientWidth - this.options.edge_resistance)
